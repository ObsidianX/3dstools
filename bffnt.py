...
class Bffnt:
    ...
    def _parse_header(self, data):
        ...
        magic, bom, header_size, self.version, file_size, sections, unknown = struct.unpack(FFNT_HEADER_STRUCT % self.order, data)
    ...
    def _parse_tglp_header(self, data):
        magic, section_size, cell_width, cell_height, num_sheets, max_char_width, sheet_size, baseline_position, sheet_pixel_format,num_sheet_cols, num_sheet_rows, sheet_width, sheet_height, sheet_data_offset = struct.unpack(TGLP_HEADER_STRUCT % self.order, data)
